...
| 기업                                     | 설명                                                                                                                                                | 
| :-------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Google](/img/blog/google.png)         | [Google Research](https://research.google/blog/) <br/> The latest research from Google. |
| ![Linkedin](/img/blog/linkedin.jpg)     | [Linkedin Engineering Blog](https://www.linkedin.com/blog/engineering) <br/> 성장을 촉진하는 혁신을 불러일으키는 기술. |
...
| ![Paypal](/img/blog/paypal.png)         | [The PayPal Technology Blog](https://medium.com/paypal-tech) <br/> 페이팔에서 사용된 기술, 문화, 경험을 공유하는 곳입니다.           |
| ![Slack](/img/blog/slack.jpg)           | [Slack Engineering](https://slack.engineering) <br/> Slack에서 사용된 기술, 문화, 경험을 공유하는 곳입니다.         |
| ![Spotify](/img/blog/spotify.png)       | [Spotify Engineering](https://engineering.atspotify.com) <br/> 음악 뒤에 숨은 마법과 더 많은 것들에 대해. 공식 기술 블로그에 오신 것을 환영합니다.  |
| ![Cloudfare](/img/blog/cloudfare.png)   | [The Cloudflare Blog](https://blog.cloudflare.com) <br/> Cloudflare의 제품이 어떻게 구축되고, 기술이 사용되고 있는지에 대한 최신 뉴스를 확인하세요.  |
| ![Uber](/img/blog/uber.png)             | [Uber Blog](https://www.uber.com/en-KR/blog/engineering) <br/> Uber Engineering 이면의 기술.  |
| ![Delivery](/img/blog/delivery.png)     | [Delivery Hero Tech Blog](https://tech.deliveryhero.com) <br/> 딜리버리 히어로의 모든 기술에 대한 블로그. 전문가 기사와 엔지니어의 코드 예제로 가득 차 있습니다.  |
| ![Mcdonald](/img/blog/mcdonald.jpg)     | [McDonald’s Technical Blog](https://medium.com/mcdonalds-technical-blog) <br/> AI, IoT, 엣지 컴퓨팅과 같은 혁신을 활용하여 정말 멋진 기술을 개발하는 기업가들로 구성되어 있으며, 다양하고 글로벌한 팀과 함께 당사의 미래를 정의하고 있습니다.|
| ![Trivago](/img/blog/trivago.png)       | [Trivago Tech Blog](https://tech.trivago.com) <br/> 트라이바고의 기술 팀에서 얻은 통찰력, 경험 및 학습.|
| ![Grab](/img/blog/grab.png)             | [Grab Tech Blog](https://engineering.grab.com) <br/> Grab's Engineering 팀은 중요한 교통 문제를 해결하고 동남아시아 6억 2천만 명의 사람들에게 교통의 자유를 현실로 만들어 줍니다.|
| ![Dropbox](/img/blog/dropbox.png)       | [Dropbox Tech Blog](https://dropbox.tech) <br/> 드랍박스를 지탱하는 기술.|
| ![Hex](/img/blog/hex.png)               | [Hex Tech Blog](https://hex.tech/blog) <br/> 데이터 팀 정보 및 기타 뉴스.|
| ![Etsy](/img/blog/etsy.png)             | [Etsy Engineering](https://www.etsy.com/codeascraft) <br/> 기술, 엔지니어의 집단지성의 경험을 공유합니다.|
| ![Evernote](/img/blog/evernote.png)     | [Evernote blog](https://evernote.com/blog) <br/> Evernote의 모든것을 공유합니다.|
| ![Expedia](/img/blog/expedia.png)       | [Expedia Group Technology](https://medium.com/expedia-group-tech) <br/> Expedia Group Technology 팀의 이야기입니다.|
...
| ![CJ Onstyle](/img/blog/cjonstyle.png)     | [CJ 온스타일 기술 블로그](https://medium.com/cj-onstyle) <br/> TV 홈쇼핑과 모바일의 경계를 넘어, CJ온스타일만의 쇼핑 경험을 구현하기 위한 기술적 고민과 경험을 담았습니다.  |
